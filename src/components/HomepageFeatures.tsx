...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        Learn about the core concepts of Gearbox, its definitions, smart contracts and parameters
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Get from zero to hero by setting up a local development environment with our step by step tutorials
      </>
    ),
  },
  {
...
function Feature({title, image, description, url}: FeatureItem) {
  return (
    <div className={clsx('col col--4')}>
      <Link to={url} class="navbar__link">
